...
import { setValue, setClick, setOut } from '../../redux/slices/newMessangSlice'
...
const Textarea = () => {
	...
	return (
		<div className='textarea'>
			{outChat[chatNum] ? (
				<button
					onClick={() => dispatch(setOut(outChat.map((e, i) => i === chatNum? e === false: e)))}
					className='textarea__return'
				>
					Повернутися
				</button>
			) : (
				<>
					...
					<div
						ref={emojiRef}
						className={`textarea__list ${
							emojiOpen ? 'textarea__list-open' : ''
						}`}
					>
