	...
	return (
		<div className='setting-profile'>
			<button
				...
				className='setting-profile__btn'
			>
				<svg
					width='20'
					height='20'
			...
			>
				...
				<li className='setting-profile__item'>
					<img
						className='setting-profile__img'
						src='./img/user/1.jpg'
						alt='user'
					/>
				</li>
